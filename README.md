...
|--------|-----------------|-------|
| [`led-blink`](./led-blink) | [#1–#34+](https://www.youtube.com/playlist?list=PLPW8O6W-1chwyTzI3BHwBLbGQoPFxPAPM) | LED blink → minimal preemptive kernel (MyROS) → QP/C QXK RTOS → uC/OS-II RTOS (event-driven programming) |
