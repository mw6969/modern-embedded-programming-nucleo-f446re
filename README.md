...
|--------|-----------------|-------|
| [`led-blink`](./led-blink) | [#1–#12](https://www.youtube.com/playlist?list=PLPW8O6W-1chwyTzI3BHwBLbGQoPFxPAPM) | Blinking the on-board LED |
| [`startup-code`](./startup-code) | [#13-#14](https://www.youtube.com/playlist?list=PLPW8O6W-1chwyTzI3BHwBLbGQoPFxPAPM)+ | Standard startup code that gets linked with `led-blink` application |
