...
| [`startup-code`](./startup-code) | [#13](https://www.youtube.com/playlist?list=PLPW8O6W-1chwyTzI3BHwBLbGQoPFxPAPM)+ | Standard startup code that gets linked with `led-blink` application |
